...
object Dependencies {
  ...
  val http4sCirce = "org.http4s" %% "http4s-circe" % "0.21.0-M5"
  val http4sDsl = "org.http4s" %% "http4s-dsl" % http4sCirce.revision
  val http4sJettyClient = "org.http4s" %% "http4s-jetty-client" % http4sCirce.revision
